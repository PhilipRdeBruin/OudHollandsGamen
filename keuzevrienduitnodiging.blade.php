            ...
            <form id="form_speleruitnodigen" method="post" action="{{ route('actiefspeltoevoegen') }}" style="margin-top:40px">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <input required type="date" style="width:140px;text-align:center" id="aanvangsdatum" name="aanvangsdatum" onblur="zetdatum()">
                            <input required type="time" style="width:80px;text-align:center" id="aanvangstijd" name="aanvangstijd" onblur="zetdatum()">
